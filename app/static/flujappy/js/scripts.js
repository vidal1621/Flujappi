	...
	NioApp.Plugins.countdown = function () {
        ...
        if ($count.exists()) {
            $count.each(function() {
                ...
                var _day_text = ($self.data('day-text')) ? $self.data('day-text') : 'Días';
                var _hour_text = ($self.data('hour-text')) ? $self.data('hour-text') : 'Horas';
                var _min_text = ($self.data('min-text')) ? $self.data('min-text') : 'Min';
                var _sec_text = ($self.data('sec-text')) ? $self.data('sec-text') : 'Seg';
